            ...
            <div className="bg-[#1e1e1e] p-8">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    <label htmlFor="name" className="block text-gray-500 font-mono text-xs mb-2">
                      $ echo "NAME" {">"} name.txt
                    </label>
                    <input
                      id="name"
                  ...
                  <div>
                    <label htmlFor="email" className="block text-gray-500 font-mono text-xs mb-2">
                  ...
                  <div>
                    <label htmlFor="message" className="block text-gray-500 font-mono text-xs mb-2">
                      $ cat {">"} message.txt
                    </label>
                    <textarea
                      id="message"
