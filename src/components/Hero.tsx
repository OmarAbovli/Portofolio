          ...
          <div className="p-8 md:p-12 space-y-6 relative z-10 bg-[#1e1e1e]/95 max-h-[600px] overflow-y-auto">
            ...
            <div className="flex flex-wrap gap-4 pt-4 border-t border-white/10">
              ...
              <div className="flex items-center gap-4 px-6">
                <SocialLink href="https://github.com/OmarAbovli" icon={<Github size={18} />} ariaLabel="GitHub Profile" />
                <SocialLink href="https://www.linkedin.com/in/omar-abovli-3652b1263/" icon={<Linkedin size={18} />} ariaLabel="LinkedIn Profile" />
                <SocialLink href="mailto:omarabovli@gmail.com" icon={<Mail size={18} />} ariaLabel="Send Email" />
              </div>
            </div>
          </div>
        </div>
...
const SocialLink = ({ href, icon, ariaLabel }: { href: string; icon: React.ReactNode; ariaLabel: string }) => (
  <a
    href={href}
    target="_blank"
