        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {tasks.map((task, index) => (
              <div
                key={task.id}
                className={`bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 transition-all transform hover:scale-[1.02] hover:border-cyan-400/50 ${
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-start gap-3">
                    <button
                      ...
                      className={`mt-1 p-2 rounded-full transition-all transform hover:scale-110 ${
                        task.completed 
