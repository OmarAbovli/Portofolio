              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-slate-300">
                    <strong className="text-white">Performance Optimization:</strong> Building lightning-fast applications with modern best practices
                  </p>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-2 h-2 bg-cyan-400 rounded-full mt-2 flex-shrink-0" />
                  <p className="text-slate-300">
                    <strong className="text-white">Scalable Architecture:</strong> Designing systems that grow with your business needs
                  </p>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-2 h-2 bg-cyan-400 rounded-full mt-2 flex-shrink-0" />
                  <p className="text-slate-300">
                    <strong className="text-white">User-Centric Design:</strong> Creating intuitive interfaces that users love
                  </p>
                </div>
              </div>
            </div>
